...
namespace FUNWAPCLASS
{
    ...
    public class AssignmentStatement : Stmt
    {
        ...
        private Exp exp1;
        bool isAsync = false;
        //Declare the delegate for the async call. (i.e => e1.Evaluate())

        private delegate SYMBOL_INFO iComputeAsynecCallAssigment(RUNTIME_CONTEXT cont);
        ...
        public AssignmentStatement(SYMBOL_INFO var, Exp e,bool Async)
        {
