...
{
    /// <summary>
    ///  Type info enumerations  Data type
    /// </summary>
    public enum TYPE_INFO
    {
        TYPE_ILLEGAL = -1, // NOT A TYPE
        TYPE_NUMERIC,      //  Double number(is equvalent to double in C# ) 
    ...
    public enum TOKEN
    {
        ...
        TOK_SEMI, // semi coulen; 

        TOK_VAR,    // var key word
        ...
        TOK_CCBR,           // "}"Close curly Bracket
        TOK_OCBR,           //"{" Open curely Bracket 
        TOK_EOF,
        TOK_ASYNC          // async
    }
    ...
    public class Lexer
    {
        ...
        String IExpr;     // Expression string(grabbed from programe.ap) 
        ...
        protected TOKEN Last_Token;     // Last final token
        ...
        public Lexer(String Expr)
        {
            ...
            keyword[9] = new ValueTable(TOKEN.TOK_ELSE, "ELSE");
            keyword[10] = new ValueTable(TOKEN.TOK_FUNCTION, "FUN");
            keyword[11] = new ValueTable(TOKEN.TOK_RETURN, "RETURN");
            keyword[12] = new ValueTable(TOKEN.TOK_VAR, "VAR");
            keyword[13] = new ValueTable(TOKEN.TOK_ASYNC, "ASYNC");
        ...
        /// <summary>
        ///    Skip to the End of Line use for comment
        /// </summary>
